...
const RoomBooking = () => {
  ...
  const validateForm = () => {
    const { customerName, customerEmail, customerPhone, checkIn, checkOut } =
      formData;
    if (
      !customerName ||
      !customerEmail ||
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 py-3">
          <img
            src={flower_Image}
            alt=""
            className="h-10 items-center mx-auto my-4"
          />
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-amber-600 to-orange-500 mx-auto mt-3 rounded-full"></div>
        </div>
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-gray-800 border-b-2 border-orange-400 pb-2">
                  Guest Details
                </h3>
                ...
                <div>
                  ...
                  >
                    <option value="standard">
                      Standard Room - ₹{roomDetails.standard.price}/night
                    </option>
                    <option value="deluxe">
                      Deluxe Room - ₹{roomDetails.deluxe.price}/night
                    </option>
                    <option value="suite">
                      Suite - ₹{roomDetails.suite.price}/night
                    </option>
                  </select>
                </div>
            ...
            {totalAmount > 0 && (
              <div className="mt-6 bg-gradient-to-br from-orange-50 to-amber-50 rounded-lg p-4 border-2 border-orange-200">
                <h4 className="font-semibold text-gray-800 mb-2 text-center text-lg">
                  Booking Summary
                </h4>
                <div className="space-y-1 text-sm">
                  ...
                  <p className="flex justify-between">
                    ...
                    <span className="font-medium">
                      ₹{roomDetails[formData.roomType]?.price}
                    </span>
                  </p>
            ...
            <div className="mt-8">
              <button
                ...
                className={`w-full py-3 px-4 rounded-lg text-white font-semibold transition-all transform ${
                  loading || totalAmount === 0
                    ? "bg-gray-400 cursor-not-allowed"
                    : "bg-gradient-to-r from-amber-600 to-orange-500 hover:from-amber-700 hover:to-orange-600 hover:scale-[1.02] shadow-lg hover:shadow-xl"
                }`}
              >
                {loading ? (
